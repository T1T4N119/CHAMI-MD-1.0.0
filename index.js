...
const sessdata = config.SESSION_ID.replace("chami~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello CHAMI-MD CONNECTED*

╭─〔 *🤖 𝙲𝙷𝙰𝙼𝙸-𝙼𝙳 𝚆𝙰 𝙱𝙾𝚃* 〕  
├─▸ *Simplicity. Speed. Power. BY CHAMI |*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing CHAMI-MD!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029VbAvLMM0Vyc9KfRBrS3i) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](TEMPORARY UNVAILABLE)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY CHAMI_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://raw.githubusercontent.com/Ubalasiya/Chamihelper/refs/heads/main/chami-md-main.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    ...
    let isCreator = [udp, jawad, config.DEV]
					map(v => String(v).replace(/[^0-9]/g, '') + '94766315540@s.whatsapp.net')
						          .includes(mek.sender);
